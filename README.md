...
## Genetic Algorithm
This project uses a Genetic Algorithm (GA) to solve the Task Allocation problem, assigning N tasks to M students with the goal of minimizing the total completion time.
